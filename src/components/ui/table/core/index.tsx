...
>(({ className = "", ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-neutral-30 data-[state=selected]:bg-neutral-30",
      className
    )}
    {...props}
  />
  ...
  return (
    <TableRow>
      <td className="px-4 py-5" colSpan={totalColumns}>
        <div className="flex flex-col items-center min-h-[300px] justify-center gap-2">
          <span className="text-greyscale-8 body-reguler-14">
